  ...
  return (
    <aside className="hidden lg:flex flex-col py-8 gap-4 h-screen w-64 border-r border-outline-variant/15 bg-surface-dim sticky top-0">
      ...
      <nav className="flex-1 flex flex-col gap-1">
        <a
          className="bg-surface-container-high text-primary rounded-r-full border-l-4 border-primary px-6 py-3 flex items-center gap-3 transition-all scale-[0.98] active:duration-150"
          href="#"
        >
        ...
        <a
          className="text-primary/50 px-6 py-3 hover:bg-surface-container-low hover:text-primary rounded-r-full flex items-center gap-3 transition-all"
          href="#"
        >
      ...
      <div className="px-8 mt-auto flex flex-col gap-4">
        ...
        <div className="pt-6 border-t border-outline-variant/10 flex flex-col gap-2">
          <a
            className="flex items-center gap-3 text-primary/50 text-sm hover:text-primary transition-colors"
            href="#"
          >
